...
def main():
    ...
    json_file = "neftegazarticles.json"
    json_data = []
    os.mkdir(json_path + "neftegaz_plain_text")
    ...
    for article in json_data:
        if len(article['article_title']) >= 1:
            ...
            with codecs.open(json_path+"neftegaz_plain_text/"+article_uuid+".txt", "w", "utf-8-sig") as temp:
